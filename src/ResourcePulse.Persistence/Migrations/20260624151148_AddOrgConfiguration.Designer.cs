...
namespace ResourcePulse.Persistence.Migrations
{
    ...
    [Migration("20260624151148_AddOrgConfiguration")]
    partial class AddOrgConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ResourcePulse.Domain.Allocations.Allocation", b =>
                {
                    ...
                    b.Property<Guid?>("RoleSkillId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_skill_id");
                    ...
                    b.HasIndex("RoleSkillId")
                        .HasDatabaseName("ix_allocations_role_skill_id");
                    ...
                    b.ToTable("allocations", null, t =>
                        {
                            t.HasCheckConstraint("ck_allocations_form_xor", "(resource_id IS NOT NULL AND role_skill_id IS NULL AND owner_resource_id IS NULL) OR (resource_id IS NULL AND role_skill_id IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ResourcePulse.Domain.Allocations.Allocation", b =>
                {
                    ...
                    b.HasOne("ResourcePulse.Domain.Skills.Skill", null)
                        .WithMany()
                        .HasForeignKey("RoleSkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_allocations_skills_role_skill_id");
                });
